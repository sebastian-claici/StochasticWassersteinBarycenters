...
public:
    ...
    inline int minimize(Foo& f, Vector& x, Scalar& fx)
    {
        ...
        for( ; ; )
        {
            ...
            if (DEBUG) {
              std::cout << "Before backtracking" << std::endl;
              std::cout << "Direction = " << m_drt.transpose() << std::endl;
              std::cout << "f(x) = " << fx << std::endl;
              std::cout << "x = " << x.transpose() << std::endl;
              std::cout << "grad_x = " << m_grad.transpose() << std::endl << std::endl;
            }
            ...
            if (DEBUG) {
              std::cout << "After backtracking" << std::endl;
              std::cout << "Direction = " << m_drt.transpose() << std::endl;
              std::cout << "f(x) = " << fx << std::endl;
              std::cout << "x = " << x.transpose() << std::endl;
              std::cout << "grad_x = " << m_grad.transpose() << std::endl << std::endl;
